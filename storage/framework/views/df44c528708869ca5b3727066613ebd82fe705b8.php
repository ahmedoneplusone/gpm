                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <input id="email" type="email" style="width: 100%" class="search_iput" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
...
<?php /* C:\Users\HOME\Desktop\GPM\resources\views/auth/login.blade.php */ ?>